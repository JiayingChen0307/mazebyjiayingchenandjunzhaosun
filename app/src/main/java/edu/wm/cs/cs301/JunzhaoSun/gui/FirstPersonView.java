...
import edu.wm.cs.cs301.JunzhaoSun.generation.BSPBranch;
import edu.wm.cs.cs301.JunzhaoSun.generation.BSPLeaf;
import edu.wm.cs.cs301.JunzhaoSun.generation.BSPNode;
import edu.wm.cs.cs301.JunzhaoSun.generation.Floorplan;
import edu.wm.cs.cs301.JunzhaoSun.generation.Wall;
...
public class FirstPersonView {
	...
	private void drawWall(Wall wall) {
		...
		panel.setColor(wall.getColor()[0],wall.getColor()[1],wall.getColor()[2]);
